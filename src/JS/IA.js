...
async function analizar(user, frequentSongs) {
    ...
    try {
        const initProgressCallback = (initProgress) => {
            ...
            document.getElementById('output').innerHTML =`<p id="loading"><img src="${image}" alt="loading"> ${initProgress.text}</p>`;
        };
